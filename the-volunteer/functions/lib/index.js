...
exports.submitTaskRating = (0, https_1.onCall)({ invoker: 'public' }, async (request) => {
    ...
    const updatedStreak = helper.lastCompletedDate === todayKey
...
exports.requestAdminRole = (0, https_1.onCall)({ invoker: 'public' }, async (request) => {
    ...
    const { uid, adminSecret } = request.data;
...
exports.notifyNewTaskNearby = (0, firestore_1.onDocumentCreated)('tasks/{taskId}', async (event) => {
...
exports.notifyTaskStatusChange = (0, firestore_1.onDocumentUpdated)('tasks/{taskId}', async (event) => {
    ...
    if (after.status === 'accepted' && after.creatorId) {
        ...
        const tokens = creator.data()?.fcmTokens;
    ...
    if (after.status === 'completed' && after.helperId) {
        ...
        const tokens = helper.data()?.fcmTokens;
...
exports.health = (0, https_1.onRequest)((_, response) => {
